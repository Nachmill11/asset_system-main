                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr class="text-center">
                                            ...
                                            <?php
                                            $st = $row['status'];
                                            echo "<td class='hidden' align='center'>";
                                            if ($st == '1') {
                                                echo "<b style='color:green'><i class='	fa fa-check'></i> ตรวจสอบแล้ว <b>";
                                            } elseif ($st == '2') {
                                                echo "<b style='color:green'><i class='	fa fa-check'></i> ตรวจสอบแล้ว <b>";
                                            } elseif ($st == '3') {
                                                echo "<b style='color:green'><i class='	fa fa-check'></i> ตรวจสอบแล้ว <b>";
                                                ...
                                                echo "<b style='color:red'><i class='fa fa-times'></i> ยังไม่ตรวจสอบ <b>";
                                            } else {
                                                echo "<b style='color:green'><i class='	fa fa-check'></i> ตรวจสอบแล้ว <b>";
                                            }
                                            ?>
