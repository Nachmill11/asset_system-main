  ...
  <body class="hold-transition sidebar-mini layout-fixed">
    ...
    if (@$_GET['do'] == 'success') {
      echo '<script type="text/javascript">
        swal("สำเร็จ !!", "เพิ่มข้อมูล และอนุมัติเรียบร้อย", "success");
        </script>';
      ...
      echo '<script type="text/javascript">
        swal("ผิดพลาด !!", "มีข้อมูลนี้ใช้งานในระบบ !!", "error");
        </script>';
      echo '<meta http-equiv="refresh" content="3;url=list_member.php" />';
    } else if (@$_GET['do'] == 'thai') {
      echo '<script type="text/javascript">
        swal("ผิดพลาด !!", "กรุณากรอกข้อมูลเป็นภาษาไทย !!", "error");
        </script>';
      echo '<meta http-equiv="refresh" content="3;url=list_member.php" />';
    } else if (@$_GET['do'] == 'f') {
      echo '<script type="text/javascript">
              ...
              <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                  <div class="card card-body">
                    <!-- <div align="right">
                      <a href="addMember.php" class="btn btn-success rounded-pill">
                        <i class="fa fa-plus"></i> เพิ่มข้อมูลผู้ดูแลระบบ</a>
                    </div>
                    <hr> -->
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h4 class="modal-title" id="exampleModalLabel">รายละเอียดเจ้าหน้าที่<h4>
