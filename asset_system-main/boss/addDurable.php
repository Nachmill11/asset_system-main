                                ...
                                <form action="insert_durable.php" method="POST" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="dur_number" class="form-control"  placeholder="กรอกหมายเลขสินทรัพย์" autocomplete="off" required>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="custom-file">
                                                <input type="file" name="file1" class="custom-file-input" accept="image/*" id="image" required>
