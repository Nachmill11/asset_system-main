  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-6">
            <h3>&nbsp;&nbsp;<a href="index.php">หน้าหลัก</a> /<a href="admin.php"> ข้อมูลสมาชิก</a> / <span> เพิ่มข้อมูลบุคลากร</span></h3>
          </div>
        </div>
        <hr>
        <center>
          <div class="col-md-5">
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title"><i class="fas fa-unlock-alt"></i> เพิ่มข้อมูลบุคลากร</h3>
              </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-12">
                      <select name="m_level" class="form-control" required>
                        <option value="porsonnel">บุคลากร</option>
                      </select>
                    </div>
                  </div>
                </div>
