        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="card card-body rounded-pill">
              <div class="row">
                <div class="col-sm-12">
                  <span>&nbsp;&nbsp;<a href="index.php" style="color:danger">หน้าหลัก</a><a href="list_dur_category.php" style="color:danger"> | รายการเบิกสินทรัพย์</a> |<span> สินทรัพย์</span></span>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <tbody>
                    ...
                    ?>
                        <tr class="text-center">
                          <td><img src="../img/durable/<?= $row['photo'] ?>" width="100px"></td>
