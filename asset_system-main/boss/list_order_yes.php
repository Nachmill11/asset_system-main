                                ...
                                <table id="example1" class="table table-sm table-hover dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        if(($ddt1 != "") & ($ddt2 != "")){
                                            ...
                                            WHERE order_status ='3' AND reg_date BETWEEN '$ddt1' AND '$add_date'  
                                            ORDER BY reg_date DESC";

                                        }else{
                                            $sql = "SELECT * FROM d_order 
                                            WHERE order_status ='3' ORDER BY reg_date DESC";
                                        }
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    ...
                                                    if ($status == 1) {
                                                        ...
                                                        echo "<b style='color:red'><i class='fa fa-close'></i> ยกเลิกกายืมครุภัณฑ์ <b>";
                                                    } else if ($status == 3) {
