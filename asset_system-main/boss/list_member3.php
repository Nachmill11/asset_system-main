...
<body>
  ...
  <body class="hold-transition sidebar-mini layout-fixed">
    ...
    if (@$_GET['do'] == 'success') {
      ...
      echo '<meta http-equiv="refresh" content="5;url=list_member.php" />';
              ...
              <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                  <div class="card card-body">
                    <div align="right">
                      <a href="addMember3.php" class="btn btn-success rounded-pill">
                        <i class="fa fa-plus"></i> เพิ่มข้อมูลกรรมการบริษัท</a>
                    </div>
                    <hr>
...
<script type="text/javascript">
  function del(mypage) {
    Swal.fire({
      title: 'ต้องการลบกรรมการบริษัทหรือไม่?',
      showDenyButton: true,
