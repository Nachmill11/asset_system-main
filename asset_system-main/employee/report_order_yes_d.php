                    ...
                    <div class="col-md-12">
                        <div class="card card">
                            <div class="card-header">
                                <h6 class="m-0"><i class="fas fa-list"></i> รายการอนุมัติ</h6>
                            </div>
                            <br>
                            <div>
                                ...
                                <table id="example1" class="table table-sm table-hover dataTable">
                                    ...
                                    <?php
                                        ...
                                        if(($ddt1 != "") & ($ddt2 != "")){
                                            ...
                                            WHERE NOT order_status = '1' AND date_end BETWEEN '$ddt1' AND '$add_date' AND AND cus_name = '$cus_name' 
                                            ORDER BY date_end DESC";

                                        }else{
                                            $sql = "SELECT * FROM d_order 
                                            WHERE NOT order_status = '1' AND cus_name = '$cus_name'
                                            ORDER BY date_end DESC";
                                        }
