...
$sql3 = "SELECT * FROM tb_order WHERE orderID= '$ids' ";
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="card card-body rounded-pill">
                            <div class="row">
                                <div class="col-sm-12">
                                    <h4>&nbsp;&nbsp;<a href="index.php" style="color:teal">หน้าหลัก</a> <a href="report_order.php" style="color:teal">/ รายการอนุมัติเบิกวัสดุ</a> / <span> รายละเอียดเบิกวัสดุอุปกรณ์</span></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="card card">
                        <div class="card-header">
                            <h5 class="m-0"><i class="fas fa-list"></i> รายละเอียดเบิกวัสดุอุปกรณ์</h5>
                        </div>
                        <br>
                        <div>
                            &nbsp;&nbsp;&nbsp;<a href="report_order.php" type="button" class="btn btn-secondary rounded-pill">ย้อนกลับ : <i class="fa fa-mail-reply"></i></a>
                        </div>
                        <div class="card-body">
                            <h5>เลขที่ใบเบิกวัสดุ : <?= $ids ?></h5>
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr role="row" class="info text-center" style="color: blue;">
                                        ...
                                        <th class="text-center" width="15%" >รหัสวัสดุ</th>
                                ...
                                <tbody>
                                    <?php
                                    $sql = "SELECT * FROM tb_order t, order_detail d, product p ,unit u
                                    WHERE t.orderID = d.orderID AND d.pro_id = p.pro_id 
                                    AND p.unit_id = u.unit_id AND d.orderID = '$ids'
                                    ORDER BY d.pro_id ";
                            ...
                            <form action="insentFile.php" method="POST" enctype="multipart/form-data">
