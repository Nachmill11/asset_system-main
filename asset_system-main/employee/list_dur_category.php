...
<body>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
        ...
        if (@$_GET['do'] == 'success') {
          ...
          swal("บันทึกการเบิกเรียบร้อยแล้ว", "กรุณาติดต่อเจ้าหน้าที่เพื่อดำเนินการ", "success");
          </script>';
            echo '<meta http-equiv="refresh" content="2;url=list_dur_category.php" />';
        } ?>
        <div class="wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="card card-body rounded-pill">
                            <div class="row">
                                <div class="col-sm-12">
                                    <span>&nbsp;&nbsp;<a href="index.php" style="color:danger">หน้าหลัก</a> |<span> รายการประเภทสินทรัพย์</span></span>
                                </div>
                            </div>
                        </div>
                    </div>
