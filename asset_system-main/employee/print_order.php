...
include '../condb.php';
$ids = $_GET['id'];
$sql = "SELECT * FROM d_order WHERE orderID= '$ids' ";
...
<body>
    ...
    <div class="text-left">
        ...
        <div class="row">
            <h5 class="text-center" style="border:1px solid #000;padding:4px;"><b>แบบฟอร์มเบิกครุภัณฑ์</b></h5>
            ...
            <table id="bg-table" width="100%" style="border-collapse: collapse;font-size:12pt;margin-top:8px;">
                ...
                <?php
                $sql1 = "SELECT * FROM d_order_detail d,durable p WHERE d.dur_id = p.dur_id AND d.orderID= '$ids' ";
                ...
                ?>
                    <tr>
                        ...
                        <td style="border:1px solid #000;padding:4px;"><?= $row['dur_name'] ?></td>
