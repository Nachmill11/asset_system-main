                        ...
                        <center><br><br>
                            <div class="col-md-5">
                                <div class="card card-danger">
                                    ...
                                    <form action="update_member.php" method="post" class="form-horizontal">
                                        <br>
                                        <div class="col-md-10">
                                                ...
                                                <div class="container">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12" align="left">
                                                            ...
                                                            <?php
                                                            if (empty($rs['m_num'])) { ?>
                                                                <input type="number" class="form-control" placeholder="ยังไม่ระบุข้อมูล" disabled>
                                                            <?php  } else { ?>
                                                                <input type="number" class="form-control" value="<?= $rs['m_num'] ?>" disabled>
                                                            <?php
                                                            }
                                                            ?>
                                                        </div>
                                                        <div class="col-12" align="left">
                                                            ...
                                                            <select type="text" class="form-control" name="m_level">
                                                                ...
                                                                <option value="3">กรรมการบริษัท</option>
