...
<?php
 if (@$_GET['do'] == 'success') {
   ...
   swal("สำเร็จ !!", "เสร็จเรียบร้อย", "success");
   </script>';
                ...
                <div class="content-header">
                    ...
                    <div class="col-md-12">
                        <div class="card card">
                            ...
                            <div>
                                <form name="form1" method="POST" action="list_order_back.php">
                                    <div class="row">
                                        &nbsp;&nbsp;&nbsp;<div class="col-sm-2">
                                ...
                                <table id="example1" class="table table-sm table-hover dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        if(($ddt1 != "") & ($ddt2 != "")){
                                            ...
                                            WHERE NOT order_status = '1' AND date_end BETWEEN '$ddt1' AND '$add_date' AND cus_name = '$cus_name'
                                            ORDER BY date_end DESC";

                                        }else{
                                            $sql = "SELECT * FROM d_order 
                                            WHERE NOT order_status = '1'  AND cus_name = '$cus_name' AND date_end BETWEEN '$ddt1' AND '$add_date'
                                            ORDER BY date_end DESC";
                                        }
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <?php
                                                    if ($status == 1) {
                                                        ...
                                                        echo "<b style='color:red'><i class='fa fa-close'></i> ยกเลิกการเบิก <b>";
                                                    } else if ($status == 3) {
                                                        echo "<b style='color:red'><i class='fa fa-wrench'></i> แจ้งซ่อม <b>";
                                                    }else if ($status == 4) {
                                                        echo "<i class='fa fa-spinner' style='color:green'></i>&nbsp;<b style='color:green'> รอการอนุมัติรับคืน <b>";
                                                    }
                                                    ?>
                                                </td>
