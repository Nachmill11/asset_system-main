...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 25, 2023 at 05:31 PM
...
CREATE TABLE `category` (
  ...
  `d_id` varchar(50) COLLATE utf8_unicode_ci NOT NULL COMMENT 'ไอดีปรเภทครุภัณฑ์',
  `c_name` varchar(150) COLLATE utf8_unicode_ci NOT NULL COMMENT 'ชื่อหมวดหมู่ครุภัณฑ์',
  `province_id` varchar(100) COLLATE utf8_unicode_ci NOT NULL DEFAULT '0',
  `doc_file` varchar(200) CHARACTER SET utf8 NOT NULL COMMENT 'รูป'
...
CREATE TABLE `department` (
  ...
  `d_code` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `code` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `d_name` varchar(150) COLLATE utf8_unicode_ci NOT NULL COMMENT 'ชื่อประเภทครุภัณฑ์'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `durable` (
  ...
  `dur_number` varchar(50) CHARACTER SET utf8 NOT NULL COMMENT 'หมายเลขครุภัณฑ์',
  `dur_name` varchar(100) CHARACTER SET utf8 NOT NULL COMMENT 'รายการ',
  ...
  `dur_receive` varchar(100) CHARACTER SET utf8 NOT NULL COMMENT 'วิธีการได้มา',
  `dur_position` varchar(100) CHARACTER SET utf8 NOT NULL COMMENT 'ใช้ประจำที่ ',
  `dur_change` varchar(100) CHARACTER SET utf8 NOT NULL COMMENT 'รายการเปลี่ยนแปลง',
  `status` varchar(50) CHARACTER SET utf8 NOT NULL COMMENT 'สภาพครุภัณฑ์',
  `detail` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT 'รายละเอียด',
  `photo` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT 'รูปภาพ\r\n'
...
(1, 'admin@localhost.com', 'test_admin', '123456', '', '', '', '', '', 'admin', '0000-00-00'),
(2, 'amc2@localhost.com', 'test_2', 'amc2', '', '1999995595959', '0877878788', '', '', 'boss', '0000-00-00'),
