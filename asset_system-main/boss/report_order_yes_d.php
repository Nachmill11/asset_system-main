                    ...
                    <div class="col-md-12">
                        <div class="card card">
                            <div class="card-header">
                                <h6 class="m-0"><i class="fas fa-check"></i> อนุมัติรายการสินทรัพย์</h6>
                            </div>
                            <br>
                            <div>
                                ...
                                &nbsp;<a href="print_out.php" type="button" class="btn btn-warning rounded-pill"> พิมพ์รายการออก : <i class="fas fa-print"></i></a>
                            </div>
                            <br>
                            <div>
                                ...
                                <table id="example1" class="table table-sm table-hover dataTable">
                                    ...
                                    <?php
                                        ...
                                        if(($ddt1 != "") & ($ddt2 != "")){
                                            ...
                                            WHERE NOT order_status = '1' AND reg_date BETWEEN '$ddt1' AND '$add_date' 
                                            ORDER BY reg_date DESC";

                                        }else{
                                            $sql = "SELECT * FROM d_order 
                                            WHERE NOT order_status = '1' ORDER BY reg_date DESC";
                                        }
