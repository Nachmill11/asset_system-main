                    ...
                    <div class="col-md-12">
                        <div class="card card">
                            <div class="card-header">
                                <h6 class="m-0"><i class="fas fa-trash-alt"></i> ยกเลิกรายการสินทรัพย์</h6>
                            </div>
                            <br>
                            <div>
                                ...
                                <table id="example1" class="table table-sm table-hover dataTable">
                                    ...
                                    <?php
                                        ...
                                        if(($ddt1 != "") & ($ddt2 != "")){
                                            ...
                                            WHERE order_status ='0' AND reg_date BETWEEN '$ddt1' AND '$add_date' 
                                            ORDER BY reg_date DESC";

                                        }else{
                                            $sql = "SELECT * FROM d_order 
                                            WHERE order_status ='0' ORDER BY reg_date DESC";
                                        }
