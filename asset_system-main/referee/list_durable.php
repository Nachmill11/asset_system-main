...
<body>
    <?php
    $query = "SELECT * FROM durable ORDER BY dur_id ASC";
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
        ...
        if (@$_GET['do'] == 'success') {
          ...
          swal("สำเร็จ !!", "เพิ่มรายการสินทรัพย์เรียบร้อย", "success");
          </script>';
            echo '<meta http-equiv="refresh" content="2;url=list_durable.php" />';
          ...
          swal("ลบสำเร็จ !!", "ลบข้อมูลเรียบร้อย", "success");
            ...
            echo '<script type="text/javascript">
              swal("ผิดพลาด !!", "มีข้อมูลอยู่ในระบบแล้ว", "warning");
              </script>';
            echo '<meta http-equiv="refresh" content="2;url=list_durable.php" />';
        } else if (@$_GET['do'] == 'status') {
            echo '<script type="text/javascript">
          swal("สำเร็จ !!", "แก้ไขสถานะเรียบร้อย", "success");
          </script>';
            echo '<meta http-equiv="refresh" content="2;url=list_durable.php" />';
        }
        ?>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <a href="list_durable_1.php" type="button" class="btn btn-secondary btn-sm">ใช้งานได้
                                &nbsp; <span class="badge badge-danger right rounded-pill" style="font-size: 12px;">
                                    <?php
                            ...
                            <a href="print_report_durable.php" type="button" class="btn btn-warning btn-sm">พิมพ์รายงานนำเข้า : <i class="fa fa-print"></i></a>
                        </div>
                    </div>
                    <div class="container-fluid">
                        <div class="row">
                                        ...
                                        <table id="example1" class="table table-bordered table-hover dataTable">
                                            <thead>
                                                <tr role="row" class="info" align='center' style="color: blue;">
                                                    ...
                                                    <th tabindex="0" rowspan="1" colspan="1" style="width: 25%;">รายการ</th>
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = mysqli_fetch_array($result)) { ?>
                                                    <tr>
                                                        ...
                                                        ?>
                                                        <input type="hidden" name="dur_id" value="<?= $row['dur_id']; ?>">
                                                        <input type="hidden" name="status" value="<?= $row['status']; ?>">
                                                        <td><a href="update_status_durable.php?id=<?= $row['dur_id']; ?>" title="แก้ไขสภาพสินทรัพย์" class="btn btn-secondary rounded-pill"><i class="fa fa-wrench"></i></a></td>
                                                        <td align='center'>
