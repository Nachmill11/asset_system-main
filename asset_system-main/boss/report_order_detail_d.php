                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="card card-body rounded-pill">
                            <div class="row">
                                <div class="col-sm-12">
                                    <h4>&nbsp;&nbsp;<a href="index.php" style="color:teal">หน้าหลัก</a> <a href="report_order_detail_d.php" style="color:teal">/ รายการอนุมัติยืมครุภัณฑ์</a> / <span> รายละเอียดยืมครุภัณฑ์</span></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="card card">
                            <div class="card-header">
                                <h5 class="m-0"><i class="fas fa-list"></i> รายละเอียดยืมครุภัณฑ์</h5>
                            </div>
                            <br>
                            <div>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                ...
                                                <a href="editfile_d.php?id=<?= $row1['orderID']?>" class="btn btn-warning rounded-pill">ตรวจสอบ</a>
                                            </td>
                                        </tr>
                                    </table>
                                </form>
