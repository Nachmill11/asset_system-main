                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="card card-body rounded-pill">
                            <div class="row">
                                <div class="col-sm-12">
                                    <h4>&nbsp;&nbsp;<a href="index.php" style="color:teal">หน้าหลัก /</a> <a href="report_order.php" style="color:teal"> รายการอนุมัติเบิกวัสดุ</a> /<span> ตรวจสอบ</span></b></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <center><br><br>
                            <div class="col-md-6">
                                <div class="card card-teal">
                                    ...
                                    <form action="updateFile.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                                        <br>
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                <div align="left">
                                                    <div class="col-sm-12 control-label"> เลขที่ใบเบิกวัสดุ : </div>
                                                </div>
                                                <div class="col-sm-12">
