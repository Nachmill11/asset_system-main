                            ...
                            <div class="col-md-8">
                                <div class="card card-danger">
                                    <div class="card-header">
                                        <h6 class="m-0" align="left">+<i class="fa fa-user"></i> เพิ่มข้อมูลผู้ดูแลระบบ</h6>
                                    </div>
                                                ...
                                                <div class="container">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12" align="left">
                                                            ...
                                                            <input type="text" name="m_num" class="form-control"  maxlength="13" placeholder="กรอกหมายเลขบัตรประจำตัวประชาชน" autocomplete="off" required >
                                                        </div>
                                                        <div class="col-6" align="left">
                                                            <label>โทร<span class="text-danger"> *</span></label>
                                                            <input type="text" name="telephone" class="form-control" placeholder="กรอกเบอร์โทร" autocomplete="off" maxlength="10" placeholder="กรอกข้อมูลโทรศัพท์" autocomplete="off">
                                                        </div>
                                                        <div class="col-6" align="left">
