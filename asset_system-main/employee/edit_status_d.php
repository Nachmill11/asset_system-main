                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="card card-body rounded-pill">
                            <div class="row">
                                <div class="col-sm-12">
                                <h4>&nbsp;&nbsp;<b><a href="index.php" style="color:teal">หน้าหลัก /</a> <a href="list_durable.php" style="color:teal"> รายการอุปกรณ์ครุภัณฑ์</a> /<span> ตรวจสอบสภาพการใช้งาน</span></b></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-5">
                                <div class="card card-teal">
                                    <div class="card-header">
                                        <h3 class="card-title"><i class="fa fa-wrench"></i> ตรวจสอบสภาพการใช้งาน</h3>
                                    </div>
