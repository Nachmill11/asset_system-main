                                        ...
                                        ?>
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <?php
                                                    if ($status == 1) {
                                                        echo "<b style='color:gray'><i class='fa fa-close'></i> รออนุมัติ <b>";
                                                    } else if ($status == 2) {
                                                ...
                                                <a href="pay_order_d.php?id=<?= $row['orderID'] ?>" type="button" class="btn btn-success btn-sm rounded-pill " onclick="del1(this.href); return false;">อนุมัติ : <i class='fas fa-check'></i></a>
